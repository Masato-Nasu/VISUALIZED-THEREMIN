...
const SW_VERSION = "theremin-20251018044607";
const CACHE = "pwa-cache-" + SW_VERSION;

// 必ず更新させたいアセット
const ASSETS = [
  "./",
  "./index.html?v=20251018044607",
  "./manifest.json?v=20251018044607",
  "./icon-192.png?v=20251018044607",
  "./icon-512.png?v=20251018044607"
];
